...
class _SearchState extends State<Search> {
  ...
  Future<void> _downloadFile(String videoUrl, String fileName, BuildContext context) async {
    ...
    // Use a different directory for saving the downloaded file
    final directory = await getExternalStorageDirectory(); // Example: Use application documents directory
    ...
    try {
      ...
      final headers = {
        'X-RapidAPI-Key': 'de463dd3d2mshd7e3c7e28ebad4bp1f21aejsn18f6350c2fa8',
      ...
      if (response.statusCode == 200) {
        ...
        print('File downloaded to: $directory');
      } else {
